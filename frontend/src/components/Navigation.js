...
function Navigation() {
    ...
    return (
        <Navbar expand="lg" className="shadow p-3  bg-black ">
            <Container>
                <LinkContainer to="/">
                    <Navbar.Brand className="text-white h1">Ecomern</Navbar.Brand>
                </LinkContainer>
                    ...
                    <Nav className="ms-auto">
                        ...
                        {!user && (
                            <LinkContainer to="/login">
                                <Nav.Link className="text-white h3">Login</Nav.Link>
                            </LinkContainer>
                        )}
                        {user && !user.isAdmin && (
                        ...
                        {user && (
                            <>
                                <Nav.Link style={{ position: "relative" }} onClick={handleToggleNotifications}>
                                    <i className="fas fa-bell text-white" ref={bellRef} data-count={unreadNotifications || null}></i>
                                </Nav.Link>
